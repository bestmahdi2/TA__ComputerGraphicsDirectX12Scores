...
1 | علیرضا رئیسی | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | <a href=""><img src="https://img.shields.io/badge/144-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>بسیار کامل و خوب 🙏🏻
1 | مهسا زارع | ✅ | ✅ | ✅ | ✅ | ❌ | ✅ | ❌ | <a href=""><img src="https://img.shields.io/badge/144-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>بسیار کامل و خوب 🙏🏻
2 | شقایق اعرابی | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/134-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>فرمت فایل خواسته شده رعایت نشده است.
2 | محمدمهدی صالحی | ✅ | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/134-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>فرمت فایل خواسته شده رعایت نشده است.
3 | نرجس اسپنانی | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>فرمت فایل خواسته شده رعایت نشده است.
3 | کیان امیری | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>فرمت فایل خواسته شده رعایت نشده است.
3 | امیرحسین باقرزاده | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>سوال 2 بسیار کلی پاسخ داده شده است. فرمت فایل خواسته شده رعایت نشده است.
3 | شایان برجیان | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>خوش خط بود 🙏🏻
3 | علیرضا فروزنده | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>سوال 2 بسیار کلی پاسخ داده شده است.
3 | آرمین منصوری | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>سوال 2 بسیار کلی پاسخ داده شده است. فرمت فایل خواسته شده رعایت نشده است.
3 | ابوالفضل نجف‌پور | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/114-318CE7.svg"/></a> | از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.</br>سوال 2 بسیار کلی پاسخ داده شده است.
4 | پرنا احمدیان | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/100-318CE7.svg"/></a> | 
4 | مهدی جمالی | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/100-318CE7.svg"/></a> | 
...
5 | پوریا رضوی | ✅ | ➖ | ➖ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/69-318CE7.svg"/></a> | سوال 2 حل نشده است.</br>از امتیازات اضافی قبلی (14) به مقدار 14 کسر شد و به اینجا اضافه شد.
6 | عقیل سمیعی | ✅ | ➖ | ➖ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/55-318CE7.svg"/></a> | سوال 2 حل نشده است.
7 | پوریا طالبیان | ❌ | ❌ | ❓ | ❓ | ❓ | ❓ | ❓ | <a href=""><img src="https://img.shields.io/badge/0-318CE7.svg"/></a> | تکلیف در گیتهاب ارسال نشده است.
...
7 | علی عصارزادگان | ✅ | ✅ | ➖ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/68-318CE7.svg"/></a> | سوال 2.1(b) و 2.4 جواب غلط است.
8 | پوریا طالبیان | ❌ | ➖ | ➖ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/26-318CE7.svg"/></a> | سوال 2.1 و 2.4 و 2.5 و 2.17 حل نشده است.
8 | حسین محمدخانی | ❌ | ➖ | ➖ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/26-318CE7.svg"/></a> | سوال 2.1 و 2.4 و 2.5 و 2.17 حل نشده است.
...
3 | پرنا احمدیان | ✅ | ✅ | ➖ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/100-318CE7.svg"/></a> | سوال Determinant جواب غلط است.</br>از امتیازات اضافی قبلی (30) به مقدار 16 کسر شد و به اینجا اضافه شد.
...
3 | مهسا زارع | ❌ | ✅ | ✅ | ✅ | ❌ | ❌ | ❌ | <a href=""><img src="https://img.shields.io/badge/100-318CE7.svg"/></a> | از امتیازات اضافی قبلی (30) به مقدار 5 کسر شد و به اینجا اضافه شد.
